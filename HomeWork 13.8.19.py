...
while person != 0:
    ...
    if age_for_ticket < 18:  # Если посетителю конференции менее 18 лет, то он проходит на конференцию бесплатно.
        print('Билет бесплатный')
    elif 25 > age_for_ticket >= 18:   #От 18 до 25 лет — 990 руб.
        cash += 990
        print('Стоимость билета: 990 руб.')
    else:    #От 25 лет — полная стоимость 1390 руб.
        cash += 1390
        print('Стоимость билета: 1390 руб.')
    person -= 1

if tickets > 3:  #Скидка 10%
